...
$(document).ready(function () {
  ...
  $(document).on("change","input[type=radio]",function(){
      console.log(summ);
    if (country == 'MT'|| country == 'PL') {
      document.getElementById('leverage').innerHTML = '<option hidden>Leverage</option><option value="1:10">1:50</option>';
    }else{
      if (summ <= 7) {
        document.getElementById('leverage').innerHTML = '<option hidden>Leverage</option><option value="1:10">1:10</option><option value="1:30">1:30</option><option value="1:50">1:50</option><option value="1:100">1:100</option><option value="1:200">1:200</option><option value="1:400">1:400</option>';
      }else{
        if (summ > 7 && summ < 15) {
          document.getElementById('leverage').innerHTML = '<option hidden>Leverage</option><option value="1:10">1:50</option>';
        }
...
function set_code() {
  var x = findElement(codes, "code", $('select[name="Country"]').val());
  document.getElementById('country_code').placeholder = x['dial_code'];
