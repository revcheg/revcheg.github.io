...
<head>
  ...
  <title>Register Real Step 1 - Forex24 Global</title>
...
<body>
  ...
  <section class="client">
    <div class="container">
      ...
      <h2 class="client__subname">Pre-Registration</h2>
      <?php
      ...
      <form id="form1" class="client__form" action="../verification/step1_handler.php" method="POST">
        ...
        <div class="client__flex">
          <select name="Country" tabindex="0" required onchange="set_code()">
          ...
          <div class="client__tel">
            <input id="country_code" class="client__country" type="tel" name="Telephone Code" placeholder="Country Code" disabled>
            <input class="client__phone" type="tel" name="Telephone" placeholder="Telephone">
          </div>
        </div>
        <div class="client__flex">
          <input type="email" name="Email" placeholder="Email" required>
          <p class="client__email">Your email will be used only for the purpose of opening your trading account and will not be shared with third parties.</p>
        </div>
        <div class="client__flex">
          <!-- <input type="hidden"> -->
          <div class="g-recaptcha" data-sitekey="6LdyaVoUAAAAAD7p7ch5hM_SO2kYG2eoZ2JCjCBO"></div>
