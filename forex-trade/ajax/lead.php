...
$querystring = test_input($_POST['querystring']);
...
$request_uri = 'https://admin.multiplymarket.com/api/v1/leads?email=' . $email;
...
$signature = hash_hmac('sha256', $nonce . $request_uri . $request_payload, 'YttJ9ubhKzt77JgA6qKQemPA5LhnEH7nY9Hr75A4LTzWeNxatGkH9JfUH7Km49JZ', false);
...
curl_setopt($ch, CURLOPT_HTTPHEADER, array(
		...
		'ACCESS_KEY: ' . 'KHJFat6amhPG8ufngSTNfVuvjAnGxm2p',
...
if( array_key_exists('Error', $result_step1_decoded) && $result_step1_decoded['Response'][0] == 'No result found.' ) {
    ...
    //API Call
    $nonce = microtime(true) * 10000;
    $request_uri = 'https://admin.multiplymarket.com/api/v1/leads';
