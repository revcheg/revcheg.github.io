(function () {
  var popup = document.querySelector('.offer');
  var close = document.querySelector('.offer__close');
  var overlay = document.querySelector('.offer__overlay');
  
  window.onload = function () {
    popup.classList.remove('offer--hide');
    overlay.classList.remove('offer__overlay--hide');
  };
  
  close.addEventListener('click', function () {
    popup.classList.add('offer--hide');
    overlay.classList.add('offer__overlay--hide');
  });
...
(function (d, w, c) {
  (w[c] = w[c] || []).push({formId:117373,host:"formdesigner.ru",formHeight:391, el: "form_117373_2", center: 0,
  fields: {
