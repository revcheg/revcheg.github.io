...
(function(){$(document).ready(function(){$('#filter').submit();});$('#filter').submit(function(e){e.preventDefault();$.ajax({url:"https://holidays.study.ua/trips/filter/",type:"POST",data:new FormData(this),processData:false,contentType:false}).done(function(data){$(".loop").html(data);});});$(document).on("click",".pagination",function(e){e.preventDefault();var btn=$(this);var next=btn.data('next')+1;console.log(next);form=new FormData($('#filter')[0]);btn.remove();$.ajax({url:"https://holidays.study.ua/trips/filter/page-"+next+"/",type:"POST",data:form,processData:false,contentType:false}).done(function(data){$(".loop").append(data);});});})();(function(){var phone=document.querySelector('.request__input[type=tel]');phone.addEventListener('focus',function(){if(phone.value==''){phone.value='+380';}
...
showPopup(currentPhoto);currentPosition=currentPhoto;previewSwap(currentPosition);});overlay.addEventListener('click',function(){popup.classList.add('popup--hide');overlay.classList.add('popup__overlay--hide');});})();var programsData=[{full:true,place:0,href:'https://holidays.study.ua/winter/program/london-winter-holidays-14.html',webp:'img/program-1.webp',jpg:'img/program-1.jpg',alt:'London Winter Holidays',name:'London Winter Holidays',location:'Лондон',age:'12-17',date:'<a href="https://holidays.study.ua/winter/program/london-winter-holidays-14.html" taget="_blank">04.01 - 18.01 (2 нед.)</a>',cost:'$3500 (2 нед.)'},{full:false,place:0,href:'https://holidays.study.ua/winter/program/toronto-academic-holidays.html',webp:'img/program-2.webp',jpg:'img/program-2.jpg',alt:'Toronto Academic Holidays',name:'Toronto Academic Holidays',location:'Торонто',age:'12-17',date:'<a href="https://holidays.study.ua/winter/program/toronto-academic-holidays.html">04.01 - 18.01 (2 нед.)</a>',cost:'$4150 (2 нед.)'},{full:false,place:0,href:'https://holidays.study.ua/winter/program/canadian-high-school.html',webp:'img/program-3.webp',jpg:'img/program-3.jpg',alt:'Canadian High School',name:'Canadian High School',location:'Гамильтон',age:'12-17',date:'<a href="https://holidays.study.ua/winter/program/canadian-high-school.html">04.01 - 18.01 (2 нед.)</a>',cost:'$4350 (2 нед.)'},{full:false,place:0,href:'https://holidays.study.ua/winter/program/explore-toronto.html',webp:'img/program-4.webp',jpg:'img/program-4.jpg',alt:'Explore Toronto',name:'Explore Toronto',location:'Торонто',age:'14-17',date:'<a href="https://holidays.study.ua/winter/program/explore-toronto.html">04.01 - 18.01 (2 нед.)</a>',cost:'$3900 (2 нед.)'},{full:true,place:0,href:'https://holidays.study.ua/winter/program/discover-california.html',webp:'img/program-5.webp',jpg:'img/program-5.jpg',alt:'Discover California',name:'Discover California',location:'Лос-Анджелес',age:'13-17',date:'<a href="https://holidays.study.ua/winter/program/discover-california.html">04.01 - 18.01 (2 нед.)</a>',cost:'$5150 (2 нед.)'}];(function(){var listButton=document.querySelector('.programs__button--list');var tileButton=document.querySelector('.programs__button--tile');var list=document.querySelector('.filter__result');listButton.addEventListener('click',function(){list.classList.add('filter__result--column');listButton.classList.add('programs__button--active');tileButton.classList.remove('programs__button--active');});tileButton.addEventListener('click',function(){list.classList.remove('filter__result--column');tileButton.classList.add('programs__button--active');listButton.classList.remove('programs__button--active');});})();(function(){var list=document.querySelector('.programs__list');var load=document.querySelector('.programs__load');var listButton=document.querySelector('.programs__button--list');var programsTemplate=document.querySelector('.programs__template').content;if(document.body.clientWidth<=768){programsCounter=5;programsIncrement=5;}else if(document.body.clientWidth>768){programsCounter=5;programsIncrement=5;}
...
if(programsData[i].place){content.querySelector('.programs__full').style.display='block';content.querySelector('.programs__full').innerHTML='Осталось '+programsData[i].place+' места';}
